package com.ashton.coinclassifier.ml;
...
public final class Model {
  ...
  public Outputs process(@NonNull TensorBuffer inputFeature0, @NonNull TensorBuffer inputFeature1,
      @NonNull TensorBuffer inputFeature2) {
    TensorBuffer processedinputFeature0 = inputFeature0;
    TensorBuffer processedinputFeature1 = inputFeature1;
    TensorBuffer processedinputFeature2 = inputFeature2;
    Outputs outputs = new Outputs(model);
    model.run(new Object[] {processedinputFeature0.getBuffer(),processedinputFeature1.getBuffer(),processedinputFeature2.getBuffer()}, outputs.getBuffer());
    return outputs;
  }
